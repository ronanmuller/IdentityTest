...
namespace Equinox.UI.Web.Controllers
{
    ...
    public class CustomerController : BaseController
    {
        ...
        public CustomerController(ICustomerAppService customerAppService, SignInManager<IdentityUser> signInManager)
        {
            _customerAppService = customerAppService;
            _signInManager = signInManager;
        }

        // Nova Action para o logout
        [HttpPost("customer-management/logout")]
